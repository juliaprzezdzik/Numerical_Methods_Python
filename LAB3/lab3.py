#alfa okresla tempo zbiegania do ninimum

#do sprawozdania: metoda sprzezonych gradientow 
#wykresy do metody najwiekszego spadku
#wykres reszt od numeru iteracji (ma zmierzac do zera)
#wykres wektora dlugosci rozwiazan x
#do metody sprzezonych gradientow rowniez te wykresy 

#nastepne zajecia: diagonalizacaja szukaniw wartosci wlasnych 
#metoda biskekcji 
